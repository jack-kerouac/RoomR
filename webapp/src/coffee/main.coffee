...
require ['backbone', 'base/AppRouter', 'base/ErrorLogger', 'section/MainSection', 'section/SearchSection', 'section/OfferDetailsSection'],
(Backbone, AppRouter, ErrorLogger, MainSection, SearchSection, OfferDetailsSection) ->
