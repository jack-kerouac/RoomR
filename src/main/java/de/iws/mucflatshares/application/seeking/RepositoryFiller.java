...
public class RepositoryFiller {
	...
	@Autowired
	private RoomSeekerRepository seekerRepos;
	...
	private void fillSeekers() {
		seekerRepos.add(new RoomSeeker("alice", new PersonalProfile(Gender.female, new Age(20))));
		seekerRepos.add(new RoomSeeker("bob", new PersonalProfile(Gender.male, new Age(30))));
	}
